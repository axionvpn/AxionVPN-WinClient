...
struct connection {
	...
	CHAR username[CRED_SIZE];		//User name for this account
	CHAR password[CRED_SIZE];		//Password for this axion account
	CHAR pubIP[16];					//Public IP address
	CHAR acctType[16];				//Account type, free basic, etc...
...
typedef struct {
    ...
    const TCHAR *auto_connect[MAX_CONFIGS]; //ELMO adjust this value
