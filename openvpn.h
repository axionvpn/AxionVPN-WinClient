...
INT_PTR CALLBACK AxionAuthDialogFunc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam);
INT_PTR CALLBACK AxionAuthDialogPopupFunc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam);
